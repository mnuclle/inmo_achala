    ...
    MapUtils.deserialize = function (clazz, jsonObject) {
        ...
        Object.keys(obj).forEach(function (key) {
            var propertyMetadataFn = function (propertyMetadata) {
                ...
                var clazz = getClazz(obj, key);
                if (MapUtils.isArray(clazz)) {
                    var metadata_1 = getJsonProperty(obj, key);
            ...
            var propertyMetadata = getJsonProperty(obj, key);
            if (propertyMetadata) {
                ...
                if (jsonObject && jsonObject[key] !== undefined) {
                    if (typeof jsonObject[key] === 'string'
                        && date_utils_1.DateUtils.isISODate(jsonObject[key])) {
                        obj[key] = date_utils_1.DateUtils.convertToDate(jsonObject[key]);
                    }
                    else {
